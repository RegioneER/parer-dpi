 ...
 *
 */
public class PigVRicDiarioTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Pig_V_Ric_Diario /**/";
    public static final String TABLE_NAME = "Pig_V_Ric_Diario";
    ...
    public static final String COL_TI_STATO_SESSIONE_RECUP = "ti_stato_sessione_recup";
    public static final String COL_DT_APERTURA_SESSIONE_RECUP = "dt_apertura_sessione_recup";
    ...
    static {
        ...
        map.put(COL_TI_STATO_SESSIONE_RECUP,
                new ColumnDescriptor(COL_TI_STATO_SESSIONE_RECUP, Types.VARCHAR, 20, true));
        map.put(COL_DT_APERTURA_SESSIONE_RECUP,
                new ColumnDescriptor(COL_DT_APERTURA_SESSIONE_RECUP, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_DL_LISTA_SOP_CLASS, new ColumnDescriptor(COL_DL_LISTA_SOP_CLASS, Types.VARCHAR, 2048, true));
        map.put(COL_DS_INSTITUTION_NAME, new ColumnDescriptor(COL_DS_INSTITUTION_NAME, Types.VARCHAR, 254, true));
        map.put(COL_DL_STUDY_DESCRIPTION, new ColumnDescriptor(COL_DL_STUDY_DESCRIPTION, Types.VARCHAR, 1024, true));
        map.put(COL_DS_STUDY_INSTANCE_UID, new ColumnDescriptor(COL_DS_STUDY_INSTANCE_UID, Types.VARCHAR, 254, true));
        map.put(COL_NI_STUDY_RELATED_SERIES,
                new ColumnDescriptor(COL_NI_STUDY_RELATED_SERIES, Types.DECIMAL, 22, true));
        map.put(COL_NI_STUDY_RELATED_IMAGES,
                new ColumnDescriptor(COL_NI_STUDY_RELATED_IMAGES, Types.DECIMAL, 22, true));
        map.put(COL_DS_STUDY_ID, new ColumnDescriptor(COL_DS_STUDY_ID, Types.VARCHAR, 254, true));
        map.put(COL_DT_PRESA_IN_CARICO, new ColumnDescriptor(COL_DT_PRESA_IN_CARICO, Types.TIMESTAMP, 7, true));
        map.put(COL_BL_DCM_HASH_TXT, new ColumnDescriptor(COL_BL_DCM_HASH_TXT, Types.CLOB, 4000, true));
        map.put(COL_DS_DCM_HASH, new ColumnDescriptor(COL_DS_DCM_HASH, Types.VARCHAR, 254, true));
        map.put(COL_TI_ALGO_DCM_HASH, new ColumnDescriptor(COL_TI_ALGO_DCM_HASH, Types.VARCHAR, 20, true));
        map.put(COL_CD_ENCODING_DCM_HASH, new ColumnDescriptor(COL_CD_ENCODING_DCM_HASH, Types.VARCHAR, 100, true));
        map.put(COL_BL_GLOBAL_HASH_TXT, new ColumnDescriptor(COL_BL_GLOBAL_HASH_TXT, Types.CLOB, 4000, true));
        map.put(COL_DS_GLOBAL_HASH, new ColumnDescriptor(COL_DS_GLOBAL_HASH, Types.VARCHAR, 254, true));
        map.put(COL_TI_ALGO_GLOBAL_HASH, new ColumnDescriptor(COL_TI_ALGO_GLOBAL_HASH, Types.VARCHAR, 20, true));
        map.put(COL_CD_ENCODING_GLOBAL_HASH,
                new ColumnDescriptor(COL_CD_ENCODING_GLOBAL_HASH, Types.VARCHAR, 100, true));
        map.put(COL_DS_FILE_HASH, new ColumnDescriptor(COL_DS_FILE_HASH, Types.VARCHAR, 254, true));
        map.put(COL_TI_ALGO_FILE_HASH, new ColumnDescriptor(COL_TI_ALGO_FILE_HASH, Types.VARCHAR, 20, true));
        map.put(COL_CD_ENCODING_FILE_HASH, new ColumnDescriptor(COL_CD_ENCODING_FILE_HASH, Types.VARCHAR, 100, true));
    }
