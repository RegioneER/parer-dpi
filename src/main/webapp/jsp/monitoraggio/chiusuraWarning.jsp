...
<sl:html>
<sl:head title="Chiusura warning" />
<sl:body>
	...
	<sl:content>
		...
		<sl:contentTitle title="CHIUSURA WARNING" />
		...
		<sl:newLine skipLine="true" />
		<slf:fieldSet borderHidden="true">
			<slf:lblField name="<%=MonitoraggioForm.GestioneWarning.DL_MOTIVO_CHIUSO_WARNING_STANDARD%>" colSpan="2" />
			<slf:lblField name="<%=MonitoraggioForm.GestioneWarning.DL_MOTIVO_CHIUSO_WARNING%>" colSpan="2" />
		</slf:fieldSet>
		<sl:newLine skipLine="true" />
		<div>
		...
		<sl:pulsantiera>
			<slf:lblField name="<%=MonitoraggioForm.GestioneWarning.ANNULLA_CHIUSURA_WARNING%>" width="w25" />
			<slf:lblField name="<%=MonitoraggioForm.GestioneWarning.CONFERMA_CHIUSURA_WARNING%>" width="w25" />
		</sl:pulsantiera>
	</sl:content>
	<sl:footer />
</sl:body>
